...
#### How to Read IBM Open-Source Dashboard

The Dashboard is currently a snapshot of data from the **IBM** Repositories. All the metrics are based on the _Last Updated Date_ reflected on the top of the dashboard.
